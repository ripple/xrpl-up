...
xrpl-up --network testnet account info rAliceXXXX...
xrpl-up --network testnet account balance rAliceXXXX...
...
xrpl-up --network testnet account set-regular-key \
  --key rRegularKeyXXXX... --seed sEdAliceXXXX...

# 4. Inspect Alice's trust lines, open DEX offers, and recent transactions
xrpl-up --network testnet account trust-lines rAliceXXXX...
xrpl-up --network testnet account offers rAliceXXXX...
xrpl-up --network testnet account transactions rAliceXXXX... --limit 5

# 5. List NFTs and MPT balances on Alice's account
xrpl-up --network testnet account nfts rAliceXXXX...
xrpl-up --network testnet account mptokens rAliceXXXX...
```
